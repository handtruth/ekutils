...
int main() {
	...
	auto dict_c = query_dict.find("c");
	auto dict_d = query_dict.find("d");
	test_call((dict_c != query_dict.end() && dict_c->second == "1"), "Testing for a value in the query dictionary.");
	test_call((dict_d != query_dict.end() && dict_d->second == "2"), "Testing for a value in the query dictionary.");
	...
	dict_c = query_dict.find("c");
	dict_d = query_dict.find("d");
	test_call((dict_c != query_dict.end() && dict_c->second == "1"), "Testing for a value in the query dictionary.");
	test_call((dict_d != query_dict.end() && dict_d->second == "2"), "Testing for a value in the query dictionary.");
